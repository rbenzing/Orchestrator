...
.EXAMPLE
    .augment\skills\dev-tools\scripts\git-diff.ps1 -Staged
.EXAMPLE
    .augment\skills\dev-tools\scripts\git-diff.ps1 -Ref1 "main" -Ref2 "feature/login"
.EXAMPLE
    .augment\skills\dev-tools\scripts\git-diff.ps1 -Ref1 "HEAD~5" -Stat
#>
[CmdletBinding()]
param(
    [switch]$Staged,
