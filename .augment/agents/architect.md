...
| When | Script | Command |
|---|---|---|
| **Phase start** — check upstream research artifacts | `artifact-status.ps1` | `.augment\skills\orchestration-artifacts\scripts\artifact-status.ps1 -ProjectName "{project}"` |
| **Before handoff** — validate quality gate | `check-gate.ps1` | `.augment\skills\orchestration-artifacts\scripts\check-gate.ps1 -ProjectName "{project}" -Phase "architecture"` |
| **At handoff (UI project)** — generate handoff message | `handoff.ps1` | `.augment\skills\orchestration-handoffs\scripts\handoff.ps1 -From "Architect" -To "UI Designer" -ProjectName "{project}" -Findings "decision1","decision2"` |
| **At handoff (backend-only)** — skip UI Designer | `handoff.ps1` | `.augment\skills\orchestration-handoffs\scripts\handoff.ps1 -From "Architect" -To "Planner" -ProjectName "{project}" -Findings "decision1","decision2"` |
