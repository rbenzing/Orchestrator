...
.EXAMPLE
    .claude\skills\ng-build\scripts\run-build.ps1 -ProjectPath "ClientApp"
.EXAMPLE
    .claude\skills\ng-build\scripts\run-build.ps1 -ProjectPath "." -LegacyOpenSSL -Configuration "production"
.EXAMPLE
    .claude\skills\ng-build\scripts\run-build.ps1 -ProjectPath "ClientApp" -ScriptName "build:prod"
#>
[CmdletBinding()]
param(
...
Write-Host "Building Angular project in: $resolved"
