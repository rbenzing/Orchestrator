...
.EXAMPLE
    .claude\skills\truncate-error-log\scripts\truncate-error-log.ps1 -Command "dotnet test"
.EXAMPLE
    .claude\skills\truncate-error-log\scripts\truncate-error-log.ps1 `
...
Write-Host "[truncate-error-log] Running: $Command"
...
Write-Host "Raw output: $totalLines lines  |  Exit code: $exitCode"
