...
```
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "${CLAUDE_PLUGIN_ROOT}\skills\truncate-error-log\scripts\truncate-error-log.ps1" -Command "npm test" -MaxLines 30
```
