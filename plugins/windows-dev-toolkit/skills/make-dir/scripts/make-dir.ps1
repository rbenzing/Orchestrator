...
.EXAMPLE
    .claude\skills\make-dir\scripts\make-dir.ps1 -Path "src\components"
.EXAMPLE
    .claude\skills\make-dir\scripts\make-dir.ps1 -Path "src\models","src\services","src\utils"
#>
[CmdletBinding()]
param(
...
Write-Host "Summary: $($created.Count) created, $($skipped.Count) skipped"