...
.EXAMPLE
    .claude\skills\rename-item\scripts\rename-item.ps1 -Path "src\utils.js" -NewName "helpers.js"
.EXAMPLE
    .claude\skills\rename-item\scripts\rename-item.ps1 -Path "src\old-module" -NewName "new-module"
#>
[CmdletBinding()]
param(
