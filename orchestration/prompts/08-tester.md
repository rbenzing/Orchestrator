...
- **Test authoring start** — check upstream planning artifacts: `.augment\skills\orchestration-artifacts\scripts\artifact-status.ps1 -ProjectName "{project}" -Phase "planning"`
...
- **Validation start** — check upstream artifacts: `.augment\skills\orchestration-artifacts\scripts\artifact-status.ps1 -ProjectName "{project}" -Phase "development"`
