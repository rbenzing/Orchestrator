...
- **Before handoff** — validate quality gate: `.augment\skills\orchestration-artifacts\scripts\check-gate.ps1 -ProjectName "{project}" -Phase "ui-design"`
- **At handoff** — generate handoff message: `.augment\skills\orchestration-handoffs\scripts\handoff.ps1 -From "UI Designer" -To "Planner" -ProjectName "{project}" -Findings "decision1","decision2"`
